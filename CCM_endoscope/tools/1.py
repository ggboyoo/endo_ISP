...
def isp_invert_isp_test(raw_file: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        reconstructed_raw = invert_result['raw']
        ...
        if isp_result['color_img'] is not None and second_isp_result['color_img'] is not None:
            ...
            isp_psnr, isp_roi_info = calculate_psnr_circular_roi(isp_result['color_img_16bit'], second_isp_result['color_img_16bit'], 4095, roi_enabled=roi_enabled)
...
def main():
    ...
    config = {
        ...
        # ISP参数路径
        'DARK_RAW_PATH': r"F:\ZJU\Picture\is",
