...
# 输入路径配置
INPUT_PATH = r"F:\ZJU\Picture\denoise\g13\1.raw"  # 灰阶板图RAW文件夹路径
DARK_RAW_PATH = r"F:\ZJU\Picture\dark\g13\average_dark.raw"  # 暗电流图像路径（可选）
...
# 输出配置
OUTPUT_DIRECTORY =  r"F:\ZJU\Picture\denoise\g13"  # 输出目录（None为自动生成）
